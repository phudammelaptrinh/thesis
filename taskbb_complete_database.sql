-- =============================================
-- TASKBB - COMPLETE DATABASE SETUP
-- Ngày tạo: 2025-12-11
-- Mô tả: File SQL tổng hợp đầy đủ cho hệ thống TaskBB
-- =============================================
...
--
-- Host: localhost:3306
-- Generation Time: Dec 09, 2025 at 03:55 PM
...
CREATE TABLE `tasks` (
  ...
  `report_file_original` VARCHAR(255) NULL,
...
(23, 'CV_8', 'cv_8', 2, 4, 8, '2025-11-03 00:00:00', 'Urgent', 'Completed', 'abc', 'cv8.pdf', NULL, 'Trung bình', '2025-11-17 05:18:08', '2025-12-01 03:10:00'),
...
-- =============================================
-- PHẦN 2: MIGRATION - CẬP NHẬT CẤU TRÚC
-- =============================================

-- Lưu ý: Cột report_file_original đã được thêm vào trong phần tạo bảng tasks ở trên
-- Nếu bạn đã có database và cần thêm cột này, hãy chạy lệnh sau:
-- ALTER TABLE tasks ADD COLUMN report_file_original VARCHAR(255) NULL AFTER report_file;
...
-- KẾT THÚC FILE SQL
-- Hướng dẫn sử dụng:
-- 1. Import file này vào MySQL/MariaDB
-- 2. Tất cả bảng và dữ liệu mẫu sẽ được tạo tự động
-- 3. Cột report_file_original đã được tích hợp sẵn
-- =============================================
